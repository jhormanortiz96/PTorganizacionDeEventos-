    ...
    <header>
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark" style="color: white !important;">
            <div class="container-fluid">
                <a class="navbar-brand" href="index"><img src="images/logotemp.jpeg" alt="" width="50px" height="50px" style="border-radius: 200px; object-fit: cover; border: #fff; border: 1px solid white"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link navbar-custom-button-hover" href="index.php#Servicios">Servicios</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link navbar-custom-button-hover" href="listado.php">Listado de modalidades</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link navbar-custom-button-hover" aria-disabled="true" href="index.html#Contacto">Contáctenos</a>
                        </li>
    ...
    <section>
        <section  class="container-fluid">
            ...
            <div class="container mt-5 py-4">
                ...
                <div class="container position-relative" id="Nosotros">
                    <div class="d-flex justify-content-center">
                        <h2 class="mt-5 Mititulo" id="Nosotros">Nosotros</h2>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="d-flex justify-content-center mt-5">
                                <h2 class="mt-4 mb-4" style="color: #211879;">Misión</h2>
                            </div>
                            <p>Desarrollar una plataforma digital innovadora que permita a los estudiantes de instituciones educativas en Colombia identificar y seleccionar de manera efectiva su orientación vocacional.</p>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex justify-content-center mt-5">
                                <h2 class="mt-4 mb-4" style="color: #211879;">Visión</h2>
                            </div>
                            <p>En el 2030 seremos reconocidos como la plataforma líder en Colombia para la orientación vocacional y la selección de media técnica.</p>
                        </div>
                    </div>
                </div>
        </section>
        <section style="background-color: rgb(200, 200, 200) !important" class="">
                <div class="d-flex justify-content-center mt-5" style="background-color: #212529">
                    <h2 class="mt-5 mb-5 Mititulo" style="color: #6EC5FF !important;">Nuestro Equipo</h2>
                </div>
                ...
                <div class="row mb-5">
                    <div class="col-md-4 col-sm-12">
                        <div class="d-flex justify-content-center mt-4 mb-3">
                            <img class="foto" src="images/wolf.jpeg" alt="Alternate Text" width="200px" height="200px" style="object-fit: cover; object-position: 0px -90px;" >

                        </div>
                        <div class="d-flex justify-content-center mb-4">

                            <h4>Emmanuel Echeverri Quintero</h4><br />
                        </div>

                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="d-flex justify-content-center mt-4 mb-3">
                            <img class="foto" src="images/kris.jpeg" alt="Alternate Text" width="200px" height="200px" style="object-fit: cover; object-position: 0px -80px"/>

                        </div>
                        <div class="d-flex justify-content-center">

                            <h4>Atara Kristin Villarreal Mendoza</h4><br />
                        </div>

                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="d-flex justify-content-center mt-4 mb-3">
                            <img class="foto" src="images/valbuenas.jpeg" alt="Alternate Text" width="200px" height="200px" style="object-fit: cover; object-position: 0px -100px" />

                        </div>
                        <div class="d-flex justify-content-center">

                            <h4>Valery Valbuenas Ramírez</h4><br />
                        </div>
