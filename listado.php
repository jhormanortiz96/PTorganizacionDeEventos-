                    ...
                    <div class="d-flex align-items-center navbar-nav">
                        ...
                        <?php
                            if (isset($_SESSION['IdRol']) && $_SESSION['IdRol'] == 1) {
                                ...
                                echo '<a class="nav-link" aria-disabled="true" href="login.php">Ingresar</a>';
                            }
    ...
    <section class="mt-5 mb-5" id="Servicios">
        <div class="container mt-5">
            ...
            <div class="d-flex justify-content-center mt-5 mb-5">
                <h2 class="mt-5" style="text-align: center; margin-top: 6.5% !important;">Listado de modalidades de la <br> Institución Educativa Luis López de Mesa</h2>
            </div>

            <div class="row mb-5">
                <div class="col-md-6 col-sm-12">
                    <div class="card " style="max-width: 540px;">
                        <div class="row g-0 list-item-transition">
                            <div class="col-md-4 d-flex align-items-center justify-content-center">
                                <a href="medias/ingles.php">
                                <i class="fa-solid fa-person-chalkboard icono"></i>
                                </a>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <a href="medias/ingles.php" style="text-decoration: none; color: #000000;">
                                    <h5 class="card-title" style="color: #211879;">MEDIA ACADÉMICA CON ÉNFASIS EN INGLÉS <br>(SENA)</h5>
                                    <p class="card-text">Formación en competencias comunicativas para comprender, hablar, leer y escribir en inglés con fluidez, mediante gramática, vocabulario, conversación, lectura y redacción académica y profesional.</p>
                                    <br /><br />
                                    </a>
                                </div>
                            </div>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="card mb-3" style="max-width: 540px;">
                        <div class="row g-0 list-item-transition">
                            <div class="col-md-4 d-flex align-items-center justify-content-center">
                                <a href="../medias/software.php">
                                <i class="fa-regular fa-square-check icono"></i>
                                </a>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <a href="medias/software.php" style="text-decoration: none; color: #000000;">
                                    <h5 class="card-title" style="color: #211879;">TÉCNICO LABORAL EN DESARROLLO DE SOFTWARE
                                        <br>(IU PASCUAL BRAVO)</h5>
                                    <p class="card-text">Forma en programación, desarrollo web, bases de datos y uso de lenguajes y herramientas para crear y mantener aplicaciones web y de escritorio.</p>
                                    </a>
                                </div>
                            </div>
                            </a>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="card mb-3" style="max-width: 540px;">
                        <div class="row g-0 list-item-transition">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    <a href="medias/gestion.php" style="text-decoration: none; color: #000000;">
                                    <h5 class="card-title" style="color: #211879;">TÉCNICO AUXILIAR EN RECURSOS HUMANOS <br>(CESDE)</h5>
                                    <p class="card-text">Formación para apoyar procesos de gestión humana en selección, contratación, desarrollo del talento, seguridad y salud en el trabajo, además de la gestión administrativa, con disciplina, orden y honestidad.</p>
                                    <br /><br />
                                    </a>
                                </div>
                            </div>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="card mb-3" style="max-width: 540px;">
                        <div class="row g-0 list-item-transition">
                            <div class="col-md-4 d-flex align-items-center justify-content-center">
                                <a href="medias/deportes.php">
                                <i class="fa-solid fa-user-graduate icono"></i>
                                </a>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <a href="medias/deportes.php" style="text-decoration: none; color: #000000;">
                                    <h5 class="card-title" style="color: #211879;">TÉCNICO EN EJECUCIÓN DE PROGRAMAS DEPORTIVOS
<br>(SENA)</h5>
                                    <p class="card-text">Formación en diseño y desarrollo de rutinas, programas y eventos deportivos y recreativos, con bases en salud, anatomía y técnicas de entrenamiento, para planificar y ejecutar actividades en contextos comunitarios e institucionales.</p>
                                    </a>
